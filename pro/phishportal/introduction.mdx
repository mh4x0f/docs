...
- **Template download workflow** – Faster onboarding of PhishPortal templates for campaign preparation.
...
WP3 Pro now includes improved template acquisition flow for PhishPortal, focused on faster campaign setup and template lifecycle handling.

<Card title="PhishPortal Templates" img="/images/pro/phishportal/templates.png">
  Streamlined template onboarding and deployment workflow.
</Card>
