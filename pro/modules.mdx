...
| `creds.monitor`   | Real-time monitoring and listing of credentials collected during sessions. |
| `epaper.ui`   | The epaper ui interface for raspberry pi zero. |
| `sys.autorun`   | Automatically executes predefined commands or scripts during system startup.|
| `wifi.connect`   | Provides Wi-Fi scanning, password handling and automatic connection to available wireless networks. |
