...
description: 'File structure Settings.'
icon: "gear"
---
...
<Note title="INI format file">
The INI file format is an informal standard used for configuration files across various software and platforms.
